...
#define ST7789_RST_PIN  PIN_LCD_RESET
#define ST7789_DC_PIN   PIN_LCD_DC
#define ST7789_CS_PIN   PIN_LCD_CS
...
/* Basic operations */
#define ST7789_RST_Clr() gpio_put(PIN_LCD_RESET, 0)
#define ST7789_RST_Set() gpio_put(PIN_LCD_RESET, 1)

#define ST7789_DC_Clr() gpio_put(PIN_LCD_DC, 0)
#define ST7789_DC_Set() gpio_put(PIN_LCD_DC, 1)

#define ST7789_Select() gpio_put(PIN_LCD_CS, 0)
#define ST7789_UnSelect() gpio_put(PIN_LCD_CS, 1)
