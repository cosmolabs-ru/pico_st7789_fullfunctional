...
static void ST7789_WriteData(uint8_t *buff, size_t buff_size)
{
	...
	while (buff_size > 0) {
		...
		spi_write_blocking(spi0, buff, chunk_size);
		buff += chunk_size;
